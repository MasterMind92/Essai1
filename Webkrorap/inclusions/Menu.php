	...
	<div class="container">
		...
		<div class="collapse navbar-collapse navHeaderCollapse">
			<ul class="nav navbar-nav navbar-left">
				<li><a href="#"><center><i class="fa fa-home fa-2"></i><br>ACCUEIL</center></a></li>
				<li><a href="#"><center><i class="fa fa-newspaper-o"></i><br>NEWS</center></a></li>
				<li><a href="#"><center><i class="fa fa-user"></i><br>BIOGRAPHIE</center></a></li>
				<li><a href="#"><center><i class="fa fa-music"></i><br>DISCOGRAPHIE</center></a></li>
				<li><a href="#"><center><i class="fa fa-photo"></i><br>PHOTOS</center></a></li>
				<li><a href="#"><center><i class="fa fa-video-camera"></i><br>VIDEOS</center></a></li>
